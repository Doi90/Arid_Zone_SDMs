...
spp_data1 <- bushfireSOS::load_pres_bg_data(species = "Bos taurus",
                                            email = "david.wilkinson.research@gmail.com",
                                            save.map = FALSE)

spp_data1$data$species <- species

spp_data2 <- bushfireSOS::load_pres_bg_data(species = "Equus asinus",
                                            email = "david.wilkinson.research@gmail.com",
                                            save.map = FALSE)

spp_data2$data$species <- species

spp_data3 <- bushfireSOS::load_pres_bg_data(species = "Equus caballus",
                                            email = "david.wilkinson.research@gmail.com",
                                            save.map = FALSE)
